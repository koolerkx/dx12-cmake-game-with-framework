/**
@filename console_sink.cpp
@brief Logging Sink implementation that outputs log messages to a Windows console. Handles attaching to an existing parent console or safely
ignoring output when no console is available.
@author Kooler Fan
**/
